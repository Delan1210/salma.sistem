...
<style>
    ...
    .package-desc { color: #706F8E; font-size: 0.95rem; line-height: 1.6; margin-bottom: 25px; }
    .btn-book { background: #3A3959; color: white; padding: 12px; border-radius: 50px; text-decoration: none; font-weight: bold; text-align: center; display: block; transition: 0.3s; }
            ...
            <div class="swiper-slide">
                <div class="package-card">
                    ...
                    <div class="package-body">
                        ...
                        <p class="package-desc">{{ \Illuminate\Support\Str::limit($package->description, 70) }}</p>
