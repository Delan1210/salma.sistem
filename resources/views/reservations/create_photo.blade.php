        ...
        <form action="{{ route('reservations.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div style="display: flex; gap: 15px;">
                <div style="flex: 1;">
                    ...
                    <input type="text" name="reservation_date" id="reservation_date" value="{{ old('reservation_date') }}" class="form-control" required placeholder="Pilih tanggal..." style="cursor: pointer;">
                </div>
                <div style="flex: 1;">
                    <label class="form-label">Waktu (Jam)</label>
                    <input type="text" name="reservation_time" id="reservation_time" value="{{ old('reservation_time') }}" class="form-control" required placeholder="Pilih jam..." style="cursor: pointer;">
                </div>
            </div>

            <div>
                <label class="form-label">Lokasi Pemotretan</label>
                <input type="text" name="location" value="{{ old('location') }}" class="form-control" required placeholder="Misal: Studio / Taman Kamboja">
            </div>
            ...
            <div>
                ...
                <textarea name="notes" rows="3" class="form-control" placeholder="Ada request khusus untuk pemotretan?">{{ old('notes') }}</textarea>
            </div>
